...
//                                } else {
//                                    Log.d("Reset Password Fail", "Failed to send email");
//                                }
//                            }
//                        });
                Intent intent = new Intent(LoginActivity2.this, ForgotPasswordActivity.class);
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(LoginActivity2.this, "User logged in successfully.",
                                        Toast.LENGTH_SHORT).show();
                            FirebaseUser user = mAuth.getCurrentUser();
                            updateUI(user);
                            } else {
                                ...
                                Toast.makeText(LoginActivity2.this, "Log in Error : " +task.getException().getMessage(),
                                        Toast.LENGTH_SHORT).show();
//                            updateUI(null);
                            }
                        }
